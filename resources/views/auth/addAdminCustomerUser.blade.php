            ...
            <div class="grid__column-10_product">
                ...
                <div style="width: 840px" class="home__product">
                    <div class="grid__row-product">
                        <!-- PRODUCT ITEM -->
                        <form method="POST" action="{{ route('admin.formAddAdminCustomerUser')}}" class="home__product-form" enctype="multipart/form-data">
                           @csrf    
                        <div class="product__item-form">
                        <input name="seller_id" type="hidden" value="">
                                <label for="">Hình ảnh người dùng</label>
                            ...
                            <div class="product__item-form">
                                <label for="">Tên người dùng</label>
