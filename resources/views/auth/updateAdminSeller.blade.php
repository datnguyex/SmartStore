            ...
            <div class="grid__column-10_product">
                ...
                <div style="width: 840px" class="home__product">
                    <div class="grid__row-product">
                        <!-- PRODUCT ITEM -->
                        <form method="POST" action="{{ route('admin.formUpdateAdminSeller')}}" class="home__product-form" enctype="multipart/form-data">
                           @csrf    
                        ...
                        <input name="seller_id" type="hidden" value="">
                                ...
                                <img id="main-imgPr" src="{{('img/img_auth/' . $seller->img) }}" alt="">
                            ...
                            <div class="product__item-form">
                                ...
                                <input value="" class="product__name-form" type="text" name="name" placeholder="{{$seller->name}}">
                            </div>
                            <input value="{{$seller->id}}" class="product__name-form" type="hidden" name="id" placeholder="">
                            <div class="product__item-form">
                                <label for="">Tên tài khoản</label>
                                <input value="" class="product__name-form" type="text" name="username" placeholder="{{$seller->username}}">
                            </div>
                            <div class="product__item-form">
                            ...
                            <div class="product__item-form">
                                ...
                                <input value="" class="product__name-form" type="text" name="email" placeholder="{{$seller->email}}">
                            </div>
                            <div class="product__item-form">
                                <label for="">Số điện thoại</label>
                                <input value="" class="product__name-form" type="text" name="phone" placeholder="{{$seller->phone}}">
                            </div>
                            <div class="product__item-form">
                                <label for="">Địa chỉ</label>
                                <input value="" class="product__name-form" type="text" name="address" placeholder="{{$seller->address}}">
                            </div>
