            ...
            <div class="grid__column-10_product">
                ...
                <div style="width: 840px" class="home__product">
                    <div class="grid__row-product">
                        <!-- PRODUCT ITEM -->
                        <form method="POST" action="{{ route('admin.formUpdateAdminCustomerUser')}}" class="home__product-form" enctype="multipart/form-data">
                           @csrf    
                        ...
                        <input name="seller_id" type="hidden" value="">
                                ...
                                <img id="main-imgPr" src="{{('img/img_auth/' . $customerUser->img) }}" alt="">
                            ...
                            <div class="product__item-form">
                                ...
                                <input value="" class="product__name-form" type="text" name="name" placeholder="{{$customerUser->name}}">
                            </div>
                            <input value="{{$customerUser->id}}" class="product__name-form" type="hidden" name="id" placeholder="">
                            <div class="product__item-form">
                                <label for="">Tên tài khoản</label>
                                <input value="" class="product__name-form" type="text" name="username" placeholder="{{$customerUser->username}}">
                            </div>
                            <div class="product__item-form">
                                <label for="">Mật khẩu</label>
                                <input value="" class="product__name-form" type="text" name="password" placeholder="{{$passwordUnhash}}">
                             </div>
                            <div class="product__item-form">
                                <label for="">Email</label>
                                <input value="" class="product__name-form" type="text" name="email" placeholder="{{$customerUser->email}}">
                            </div>
                            <div class="product__item-form">
                                <label for="">Số điện thoại</label>
                                <input value="" class="product__name-form" type="text" name="phone" placeholder="{{$customerUser->phone}}">
                            </div>
                            <div class="product__item-form">
                                <label for="">Địa chỉ</label>
                                <input value="" class="product__name-form" type="text" name="address" placeholder="{{$customerUser->address}}">
                            </div>
                            ...
                            <div class="input__DOB">
                                <input name="year" id="year" placeholder="{{$year}}" type="text" value="">
                                <input name="month" placeholder="{{$month}}" type="text" value="">
                                <input name="day" placeholder="{{$day}}" type="text" value="">
                            </div>
                        </div>
                        </div>
